        ...
        <div className='header-pdf'>
            <div className="navbar-header-pdf">
                <div className="navbar-left-header-pdf">
                    ...
                    <img src={astrocariri_logo} alt="astrocariri logo que é o símbolo do Cariri, com várias estrelas dentro e um anel de saturno ao redor" className="navbar-icon-main-pdf"></img>
                    </Link>
                    <Link to="/" className="navbar-link-pdf">
