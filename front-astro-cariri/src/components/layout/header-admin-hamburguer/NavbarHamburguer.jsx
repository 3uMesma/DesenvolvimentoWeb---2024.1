            ...
            <div className="navbar-elements">
                ...
                <div className="navbar-left">
                    <Link to="/" className="navbar-link">
                        <img src={astrocariri_logo} alt="astrocariri logo que é o símbolo do Cariri, com várias estrelas dentro e um anel de saturno ao redorastrocariri logo" className="navbar-icon-main"></img>
                    </Link>
                    <Link to="/" className="navbar-link">
