    ...
    <div className="home">
      ...
      <div className="home-about">
        ...
        <div className="home-about-right">
          <img
            src={home.imagem_descricao}
            alt="banner do Astrocariri, com por do sol ao fundo, algumas estrelas no céu, e cactos e outras palntas nativas do cariri no chão, símbolo do projeto Força Meninas no canto inferior direito"
            id="home-about-image"
          ></img>
        </div>
      </div>
