...
exports.getEventData = async (req, res, next) => {
  try {
    ...
    const query =
      "SELECT e.title, e.requester, e.contact, e.institution, e.address, e.date_, e.description, et.name_ AS event_type_name FROM event_ e JOIN eventType et ON e.event_type_id = et.type_id WHERE e.event_id = $1";
